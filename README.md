...
**First Row:**
- **Start BPM** (1-400) - Initial tempo or only tempo in normal mode
- **End BPM** (1-400) - Final tempo for ramp modes
...
- `Pierangelo Gobbo` → Your actual name
- `pierangelogobbo@yahoo.it` → Your email address
...
For licensing inquiries: pierangelogobbo@yahoo.it
...
- Contact: pierangelogobbo@yahoo.it
